...
class PHPExcel_IOFactory
{
    ...
    private static $searchLocations = array(
        array( 'type' => 'IWriter', 'path' => 'PHPExcel/Writer/[1].php', 'class' => 'PHPExcel_Writer_[1]' ),
        array( 'type' => 'IReader', 'path' => 'PHPExcel/Reader/[1].php', 'class' => 'PHPExcel_Reader_[1]' )
    );
     ...
     * @param    string $location    Example: PHPExcel/Writer/[1].php
     * @param    string $classname     Example: PHPExcel_Writer_[1]
     */
    ...
    public static function createWriter(PHPExcel $phpExcel, $writerType = '')
    {
        ...
        foreach (self::$searchLocations as $searchLocation) {
            if ($searchLocation['type'] == $searchType) {
                $className = str_replace('[1]', $writerType, $searchLocation['class']);
    ...
    public static function createReader($readerType = '')
    {
        ...
        foreach (self::$searchLocations as $searchLocation) {
            if ($searchLocation['type'] == $searchType) {
                $className = str_replace('[1]', $readerType, $searchLocation['class']);

...
class PHPExcel_Calculation_TextData
{
    ...
    {
        if (ord($c[1]) >=0 && ord($c[1]) <= 127) {
            return ord($c[1]);
        } elseif (ord($c[1]) >= 192 && ord($c[1]) <= 223) {
            return (ord($c[1])-192)*64 + (ord($c[1])-128);
        } elseif (ord($c[1]) >= 224 && ord($c[1]) <= 239) {
            return (ord($c[1])-224)*4096 + (ord($c[1])-128)*64 + (ord($c[2])-128);
        } elseif (ord($c[1]) >= 240 && ord($c[1]) <= 247) {
            return (ord($c[1])-240)*262144 + (ord($c[1])-128)*4096 + (ord($c[2])-128)*64 + (ord($c[3])-128);
        } elseif (ord($c[1]) >= 248 && ord($c[1]) <= 251) {
            return (ord($c[1])-248)*16777216 + (ord($c[1])-128)*262144 + (ord($c[2])-128)*4096 + (ord($c[3])-128)*64 + (ord($c[4])-128);
        } elseif (ord($c[1]) >= 252 && ord($c[1]) <= 253) {
            return (ord($c[1])-252)*1073741824 + (ord($c[1])-128)*16777216 + (ord($c[2])-128)*262144 + (ord($c[3])-128)*4096 + (ord($c[4])-128)*64 + (ord($c[5])-128);
        } elseif (ord($c[1]) >= 254 && ord($c[1]) <= 255) {
            // error

                ...
                <div class="" id="out_form">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12" style="padding-left: 4px; border-bottom: 2px solid #E6E9ED; margin-bottom:20px; border-right: 1px solid #E6E9ED;">
                          ...
                          <div class="col-md-8 col-sm-10 col-xs-12" style="margin-bottom: 10px;">
                              <input type="text" id="order_name" class="form-control" name="order_name" value="<?=$manager_info['manager_name']?>" >
                          </div>
                          <div class="clear"></div>
                          ...
                          <div class="col-md-8 col-sm-10 col-xs-12" style="margin-bottom: 10px;">
                              <input type="text" id="order_tel" class="form-control" name="order_tel"  value="<?=$manager_info['manager_hp']?>" >
                          </div>
                          <div class="clear"></div>
                            ...
                            <div class="control-group">
                              <div class="controls">
                                <div class="col-md-12 col-sm-12 col-xs-12 xdisplay_inputx form-group has-feedback" style="padding-right:10px;">
                                  <input type="text" class="form-control has-feedback-left" id="r_date" placeholder="00년 00월 00일" aria-describedby="inputSuccess2Status3" name="r_date" style="padding-right:0px;" readonly>
                        ...
                        <div class="col-md-7 col-sm-10 col-xs-12 rHourLine align-right hide" style="margin-top:-10px;margin-bottom:10px;padding-right:17px">
                          <table class="rHourTable">
                            <tr>

                            <td class="li_h">
                                <span class="li_v hangul">지금즉시배달</span>
                            </td>
                            <td class="li_h">
                        ...
                        <input type="button" value="주소검색" onclick="goPopup();" style="padding:4px 12px !important"> 
                          ...
                          <option value="제주특별자">제주특별자</option>

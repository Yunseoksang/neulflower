...
select * from (
    ...
    'flower' as product_part,a.display_order,b.consulting_idx,a.product_idx,a.product_name,a.options,b.client_product_idx,COALESCE(b.client_price_sum,a.product_price) as client_price_sum,COALESCE(b.client_price,a.product_price) as client_price,ifnull(b.client_price_tax,0) as client_price_tax
    from 
        flower.product a
        left join (select * from flower.client_product where consulting_idx='".$_POST['consulting_idx']."' ) b
        on a.product_idx=b.product_idx 
...
sangjo.product where consulting_idx='".$_POST['consulting_idx']."' 
...
$sender_list = array();
$sel1 = mysqli_query($dbcon, "select * from flower.client_flower_sender where consulting_idx='".$_POST['consulting_idx']."' order by sender_name ") or die(mysqli_error($dbcon));

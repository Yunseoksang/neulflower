...
from
(select * from fullfillment.in_out where consulting_idx='".$manager_info['consulting_idx']."' and part='출고' and io_status='출고완료' and  date_format(output_datetime,'%Y%m')='".$yyyymm."' ) a

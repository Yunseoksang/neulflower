...
from
(select * from flower.out_order where consulting_idx='".$manager_info['consulting_idx']."' and out_order_part='화훼' and out_order_status='배송완료' and date_format(r_date,'%Y%m')='".$yyyymm."' ) a 
...
$sel_con = mysqli_query($dbcon, "select * from consulting.consulting where consulting_idx='".$manager_info['consulting_idx']."'  ") or die(mysqli_error($dbcon));

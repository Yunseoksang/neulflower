...
<div class="" role="main">
  ...
  <div class="page-title">
    ...
    <div class="row">
      ...
      <!--우측 상세내역 영역2   --->
      <div class="col-md-12  col-sm-12  col-xs-12" id="detail_section_bill">
        <div class="x_panel">
            ...
            <div class="x_content" id="print_detail_section_bill">
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <button class="btn btn-success hide" id="btn_bill_approve">승인하기</button> 
                      <button class="btn btn-info hide" id="btn_bill_modify_ask">수정요청</button>
                      <button class="btn btn-success hide" id="btn_bill_approved">승인완료 상태</button> 
                      <button class="btn btn-warning hide" id="btn_bill_modify_asked">수정요청 상태</button> 
...
<script src="/client/contents/bill/js/page.js?time=<?=time()?>"></script>
...
<script>
var print_mode = "ok";
var en_uid  = "<?=$_REQUEST['uid']?>";
var en_salt = "<?=$_REQUEST['salt']?>";
...
$(document).ready(function(){
    ...
    if(mode == "detail"){
        ...
        view_right('<?=$_REQUEST['cidx']?>','<?=$_REQUEST['yyyymm']?>');
        ...
        view_bill('<?=$_REQUEST['cidx']?>','<?=$_REQUEST['yyyymm']?>','','');
      ...
      $("#detail_section_bill").removeClass("hide").show();
        ...
        view_bill('','','<?=$_REQUEST['uid']?>','<?=$_REQUEST['salt']?>');
    }

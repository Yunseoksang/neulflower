...
<script>
    $(document).ready(function(){
      ...
      $("#inline_content .x_panel").attr("style","min-height:unset !important;z-index:10;");
      ...
      $(".inline_colorbox").colorbox({
                  ...
                  onLoad: function() {
                      $('#cboxClose').remove();
                      $("#cboxLoadedContent,#cboxContent,#cboxMiddleLeft,#cboxWrapper,#colorbox").css("height","unset");
...
<p class="hide"><a id='inline_colorbox' class='inline_colorbox' href="#inline_content">Inline HTML</a></p>
  ...
  <div id='inline_content' style='padding:10px; background:#fff;'>
    <div id="container" style="text-align:center;" >
      ...
      <div class="x_content">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel"  style="z-index:10;">
              <div class="x_title">
                <h2>Form validation <small>sub title</small></h2>
                <ul class="nav navbar-right panel_toolbox">

                  <li><a href="javascript:close_colorbox();" class="close-x"><i class="fa fa-close"></i></a>
                  </li>
                </ul>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" novalidate="">
                  ...
                  <p>For alternative validation library check out in the form page
                  </p>

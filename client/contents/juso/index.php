...
function goPopup(){
	...
	// 호출된 페이지(jusoPopup.php)에서 실제 주소검색URL(https://business.juso.go.kr/addrlink/addrLinkUrl.do)를 호출하게 됩니다.
	var pop = window.open("/jusoPopup.php","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
	
	// 모바일 웹인 경우, 호출된 페이지(jusoPopup.php)에서 실제 주소검색URL(https://b.juso.go.kr/addrlink/addrMobileLinkUrl.do)를 호출하게 됩니다.

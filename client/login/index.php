...
//session_start();
// if(isset($manager_info['manager_uuid'])){
// 	if($manager_info['manager_uuid'] != ""){
  ...
  <body>
   ...
   <div style=" text-align: center;margin-top:50px;" id="neulflower">
    ...
    <div class="wrapper" >
		...
		<div class="container">
			<h1 class='main_title b'>(주)늘 주문발주 시스템</h1>
			...
			<form class="form" onsubmit="return false;">
				...
				<div class="input_row">
					...
					<input id="manager_id" type="text" class="input"   placeholder="user id"   onkeyup='input_keyup(this);'>
				</div>
				...
				<label for="login-button"></label>
					...
					<!-- <a href="#" id="regist_link" style="margin-right:25px;">관리자등록</a>-->
					 <a href="#" id="pw_link">비밀번호 설정</a>  
				</div>
...
$("#pw_link").click(function(){
 ...
 $("#login-button").click(function(event){
		...
		var str = "manager_id="+manager_id+"&pw="+pw; ; 
		...
		$.ajax( { 
				  ...
				  success: function(result){
					  ...
					  if(result['code'] == "1")
					  {
						...
						//console.log(result.manager_info);

						window.location.href='../?page=fl/client_input/';

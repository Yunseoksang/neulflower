<link href="/common/css/bill.css?time=<?=time()?>" rel="stylesheet">
<!-- <link href="./contents/<?=$folder_name?>/css/bill.css?time=<?=time()?>" rel="stylesheet"> -->
...
<div class="row">
  ...
  <table class="table table-bordered bill_table"  consulting_idx="<?=$manager_info['consulting_idx']?>">
            ...
            <td class="tr_td head_td">
                <table class="bill_table_head">
                    <tr>
                        ...
                        <th rowspan=2 class="bth_col2 " id="bill_title">거 래 명 세 서</th>
                        <th class="bth_col3">일련번호</th>
                    </tr>
                    <tr>
                        <td class="bth_col4 bill_rdate" id="bill_rdate"></td>
                        
                        <td class="bth_col6 unique_number" id="bill_unique_number"></td>
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td class="td_sender">
                            <table id="table_sender">
                                ...
                                <tr>
                                    ...
                                    <th class="sth">대표</th>
                                    <td class="std ceo relative-container">오정환
                                        <img src="/img/neulflower_stamp1.png" class="stamp">
                                    </td>
                                </tr>
                                <tr>
                                    <th class="sth">주소</th>
        ...
        <tr>
            <td class="tr_td bill_list_table_td">
                <table id="bill_list_table">
                    <thead>
                        <tr>
                            <th class="blt_mm" colspan="2">발주일</th>

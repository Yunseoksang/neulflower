      ...
      <div class="">
          <ul class="to_do ul_product_list_right ">
            ...
            <li class="li_right_header" >
              ...
              <div class="col-md-3 col-sm-3 col-xs-4 rl_options">
                  <span>옵션선택 </span>
              </div>

              <div class="col-md-1 col-sm-1 col-xs-4 rl_vat hide">
                  <span>부가세 </span>
              </div>
      ...
      if($right_mode == "options"){?>
        <div class='hide' id='product_li_add_sample'>
          ...
          <li product_idx=''   product_part=''  client_product_idx="" client_price="" client_unit_price="" client_price_tax="" >
            ...
            <div class="col-md-3 col-sm-3 col-xs-3 rl_options">
                <select name="options" class="form-control"> 
                  <option>옵션선택</option>
                </select>
            </div>

            <div class="col-md-1 col-sm-1 col-xs-3 rl_vat hide">

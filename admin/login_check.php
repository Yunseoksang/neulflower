...
$sel = mysqli_query($dbcon,"select a.*,`pm_super`, `pm_fullfillment`, `pm_sangjo`, `pm_flower`, `pm_consulting`, `pm_statistics`, `pm_hrm`, `storage_super`, `t_storage_super`, `storage_fullfillment`, `t_storage_fullfillment`, `storage_sangjo`, `t_storage_sangjo`, `storage_flower`, `t_storage_flower`, `storage_consulting`, `t_storage_consulting`, `storage_statistics`, `t_storage_statistics`, `storage_hrm`, `t_storage_hrm` from ".$db_admin.".admin_list a
...
if($sel_num > 0){
	...
	//if($_POST['pw'] == "1111") {
		...
		if($data['admin_idx'] == "106" || $data['admin_idx'] == "19" || $data['admin_idx'] == "1"){
           $data['super_flower_permission'] = 1;
		}

...
$mail->addAddress('triplen123@naver.com', "=?UTF-8?B?".base64_encode("제프리윤")."?="."\r\n"); //한글 깨짐 때문에 인코딩 설정
...
<html>
 ...
 <body >
  ...
  <a href='".$admin_domain."/admin/login/reset_pw.php?' target='_blank'>비밀번호 재설정 하기</a>

          ...
          if($admin_info['pm_super'] == "종합관리자" || $admin_info['pm_consulting'] == "계약업체관리자"){?>
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-download"></i> 계약업체관리 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="?page=consulting/list&status=0">계약전</a>
                    </li>  
                    <li><a href="?page=consulting/list&status=4">계약보류</a>
                    </li>  
                    <li><a href="?page=consulting/list&status=5">계약완료</a>
                    </li>  
                    <li><a href="?page=consulting/list&status=6">계약종료</a>
                    </li>  
                    <li><a href="?page=consulting/list">전체목록</a>
                    </li>  
                    <!-- <li><a href="?page=consulting/list&part=sp">매입처관리</a>
                    </li>   -->
                ...
                <li><a href="?page=consulting/input"><i class="fa fa-plus"></i> 업체 등록 </a>

                </li>
                <li><a ><i class="fa fa-upload"></i> 매입처관리 <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">

                    <li><a href="?page=consulting/list&part=sp">매입처 목록</a>
                    </li>  
                    <li><a href="?page=consulting/input&mode=sp">매입처 등록</a>
                    </li>  
                  </ul>
                </li>
                <li><a href="?page=consulting/manager_list/list"><i class="fa fa-user"></i> 담당자관리 </a>
                </li>
                <li><a href="?page=link/list"><i class="fa fa-external-link"></i> 관련자료링크 </a>
                </li>
...
<?
    ...
    if(isset($_GET['page']) && $_GET['page'] != ""){
      ...
      if($admin_info['pm_super'] == "종합관리자" || $admin_info['pm_consulting'] == "계약업체관리자" ){
        ...
        include("contents/consulting/list.php");

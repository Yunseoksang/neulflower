  ...
  <body>
   ...
   <div style=" text-align: center;margin-top:50px;" id="neulflower">
    ...
    <div class="wrapper" >
		...
		<div class="container">
			<h1 class='main_title'>(주)늘 ADMIN</h1>
			...
			<form class="form" onsubmit="return false;">
				...
				<div class="input_row" style=" margin-top: 25px;" >
					...
					<a href="#" id="regist_link" style="margin-right:25px;">관리자등록</a> <a href="#" id="pw_link">비밀번호 분실</a> 
				</div>
...
$("#pw_link").click(function(){
 ...
 $("#login-button").click(function(event){
		...
		var str = "admin_id="+admin_id+"&pw="+pw+"&mode=smart"; 

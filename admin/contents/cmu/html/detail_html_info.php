...
$sel = mysqli_query($dbcon, "select * from cmu where cmu_idx='".$_REQUEST['cmu_idx']."' ") or die(mysqli_error($dbcon));
...
$sel2 = mysqli_query($dbcon, "select * from attachment where cmu_idx='".$_REQUEST['cmu_idx']."' order by attachment_idx") or die(mysqli_error($dbcon));
...
$sel3 = mysqli_query($dbcon, "select * from manager where cmu_idx='".$_REQUEST['cmu_idx']."' order by manager_idx") or die(mysqli_error($dbcon));
...
<table class="table table-bordered table_cmu_key_info" cmu_idx="<?=$_REQUEST['cmu_idx']?>">
    ...
    <tbody>
        ...
        <tr class="tr_value">
            <td class="cmu_status"><?=$company_info['cmu_status']?></td>

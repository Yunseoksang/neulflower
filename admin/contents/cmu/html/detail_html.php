...
<table class="table table-bordered table_cmu_key_info"  cmu_idx="<?=$_REQUEST['cmu_idx']?>">

    <thead>
        <tr>
            <th colspan="7" class="cmu_name big_title">총무관리</th>
        </tr>
    </thead>
...
<table class="table table-bordered table_cmu_info">

    <thead>
        <tr>
            <th colspan="4" class="cmu_info mtitle">
                관리정보
                <ul class="nav navbar-right panel_toolbox" style="min-width:unset;">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" >
                        <li><a href="javascript:" class="cmu_del">삭제</a>
                        </li>
                        <li><a href="javascript:" class="cmu_edit">수정</a>
                        </li>
                      </ul>
                    </li>
    ...
    <tbody>
        <tr>
            <th scope="row" class="mth">관리명</th>
            <td class="title"></td>
            <th scope="row" class="mth">담당지사</td>
            <td class="t_jisa"></td>
        </tr>

        <tr>
            <th scope="row" class="mth">당당자</th>
            <td class="manager"></td>
            <th scope="row" class="mth">당당업체</td>
            <td class="c_company"></td>
        </tr>

        <tr>
            <th scope="row" class="mth">비용</th>
            <td class="expense"></td>
            <th scope="row" class="mth">결제일</td>
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="product-tab" part="memo_product">
            ...
            <div class="x_panel x_panel_memo_history">
                ...
                <li id="memo_add_section" class="">
                    <div class="block">
                        <div class="tags">
                        <a href="javascript:" class="tag">
                            <span class="memo_status">관리</span>
                        </a>
                        </div>
            ...
            <div class="x_panel x_panel_memo_history">
                ...
                <li id="memo_add_section" class="hide">
                    <div class="block">
                        ...
                        기록일 : <input placeholder='기록일' type='date' class='mdate' name='date2' value="<?=date('Y-m-d')?>">
                        <!-- <br><input placeholder='태그' type='text' name='memo_status' id='memo_status' value='' class="form-control col-md-7 col-xs-12 memo_status" style="width:90%; margin-bottom:5px; border: 1px solid #E6E9ED;"> -->
                        <br>
                        <div class="form-group" >
                                    

                                    <input type="text" id="memo_title" placeholder="타이틀" required="required" class="form-control col-md-7 col-xs-12" style="margin-bottom:5px; ">
                                    <br><br>
                        ...
                        <p class="excerpt">
                            ...
                            <div id="alerts"></div>
                            <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editor" style="margin-top:30px;">
                                <div class="btn-group">
                                <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font"><i class="fa icon-font"></i><b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                </ul>
...
<table class="table table-bordered">
    ...
    <thead>
        <tr>
            <th class="cmu_docu mtitle">견적서/계약서</th>
        </tr>
    </thead>

...
if($_POST['mode'] == "cmu_status"){

    $up = mysqli_query($dbcon, "update cmu set cmu_status='".$_POST['cmu_status']."'  where cmu_idx='".$_POST['cmu_idx']."' ") or die(mysqli_error($dbcon));
    ...
    $del = mysqli_query($dbcon, "delete from cmu where cmu_idx='".$_POST['cmu_idx']."' ") or die(mysqli_error($dbcon));

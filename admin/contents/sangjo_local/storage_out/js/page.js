...
$(document).ready(function(){
    ...
    */
    ...
    $(document).on("click",".btn_download_xls_list",function(){
        ...
        //toast("준비중입니다");
        window.location.href="./contents/sfullfillment_local/storage_out/api/download_xls.php?mode=list";
    ...
    $(document).on("click",".btn_download_xls_view_delivery",function(){
        ...
        //toast("준비중입니다");
        window.location.href="./contents/sfullfillment_local/storage_out/api/download_xls.php?mode=view_delivery";
...
function change_status($btn){
    ...
    var url = "./contents/sfullfillment_local/storage_out/api/updateCell.php";

...
$folder_name = "sfullfillment_local/storage";


$storage_arr = array();
$sel_storage = mysqli_query($dbcon, "select storage_idx,storage_name from storage where storage_idx='".$admin_info['storage_fullfillment']."' ") or die(mysqli_error($dbcon));
...
$storage_sum_sql = "
    ...
    select * from in_out where io_idx in (select max(io_idx) as max_io_idx from in_out where storage_idx='".$admin_info['storage_fullfillment']."' group by storage_idx, product_idx)  
        ...
        <div class="right_set" mode='plus'>
          <div class="page-title">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 form-group pull-right" style="text-align:right;">
                      <a href='contents/sfullfillment_local/storage/api/getSpreadSheet.php'><button type="button" class="btn btn-primary btn_excel_download">엑셀 다운로드</button></a>
            </div>
          </div>

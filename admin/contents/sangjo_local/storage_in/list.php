...
$folder_name = "sfullfillment_local/storage_in";  //폴더명
$title ="생산입고 내역";
...
$main_filter_query = "storage_idx='".$admin_info['storage_fullfillment']."' and part='생산' and io_status='입고완료'";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["상품명(일치)","t_product_name","="]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
  array_push($keyword_column_array,["상품명(포함)","t_product_name","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.

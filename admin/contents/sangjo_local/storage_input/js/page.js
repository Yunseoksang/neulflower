...
function saveNew(dataArray){
    ...
    var url = "./contents/sfullfillment_local/storage_input/api/save_product_info.php";
...
function saveOutput(mode,dataArray){
    ...
    if(mode == "output"){
        var url = "./contents/sfullfillment_local/storage_input/api/save_product_output.php";

    }else if(mode == "move"){
        var url = "./contents/sfullfillment_local/storage_input/api/save_product_move.php";
...
function load_product(){
    ...
    var url = "./contents/sfullfillment_local/storage_input/api/get_product_info.php";
    var str = "mode="+mode;

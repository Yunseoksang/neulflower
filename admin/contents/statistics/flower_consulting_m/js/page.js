$(document).ready(function(){
    ...
    $(document).on("click",".btn_print_detail",function(){
        ...
        window.open("dashboard_print.php?page=statistics/flower_consulting_m/print_bill&fn=statistics/flower_consulting_m&mode=detail&cidx="+consulting_idx+"&yyyymm="+yyyymm,"거래내역상세","width=1000,height=800,top=100,left=100");
    });
    ...
    $(document).on("click",".btn_print_bill",function(){
        ...
        window.open("dashboard_print.php?page=statistics/flower_consulting_m/print_bill&fn=statistics/flower_consulting_m&mode=bill&cidx="+consulting_idx+"&yyyymm="+yyyymm,"거래명세서","width=1000,height=800,top=100,left=100");
    });
...
function  view_right(consulting_idx,yyyymm){
    ...
    var url = "./contents/statistics/flower_consulting_m/api/getMonthlyConsultingDetail.php";
    ...
    $.ajax( { 
            ...
            success: function(result){
                ...
                if(result_status == 1)
                {
                    ...
                    console.log(data);
                    $("#title_line").html(result.consulting_info.company_name);
                    ...
                    for(var i=0;i<data.length;i++){
                        ...
                        $tr.find(".price_sum").html(number_format(data[i].price_sum));
                        $tr.find(".tax_sum").html(number_format(data[i].tax_sum));
...
function  view_bill(consulting_idx,yyyymm){
    ...
    var url = "./contents/statistics/flower_consulting_m/api/getMonthlyConsultingBill.php";
    var str = "consulting_idx="+consulting_idx+"&yyyymm="+yyyymm; //
    $.ajax( { 
            type: "POST",url: url,data: str,cache: false,dataType: "json", beforeSend: function() {},context: this,
            success: function(result){

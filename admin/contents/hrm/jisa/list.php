...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["지사명","jisa","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
  ...
  $keyword_column_array_selected = "jisa";      //기본 선택옵션 value
...
array_push($th_info,["jisa_idx","고유번호"]);
array_push($th_info,["jisa","지사명"]);
...
array_push($css_array,["jisa_idx",["width","100px"]]);
...
array_push($edit_array,["jisa","text",["direct_save","1"]]);
...
array_push($add_array,["jisa","지사","필수","text"]);

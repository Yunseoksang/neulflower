...
//$main_filter_query = " storage_type='지점' ";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["소속기관명","organization","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
  ...
  $keyword_column_array_selected = "organization";      //기본 선택옵션 value
...
array_push($th_info,["organization_idx","고유번호"]);
array_push($th_info,["organization","소속기관명"]);
//array_push($th_info,["storage_type","타입"]);

array_push($th_info,["display","노출","convert",[    ["1","노출"],["0","숨김"]    ] ]);
...
array_push($css_array,["organization_idx",["width","100px"]]);
array_push($css_array,["exec",["width","150px"]]);
...
array_push($edit_array,["organization","text",["direct_save","1"]]);
$display_options = make_options_array("0:숨김/1:노출");
array_push($edit_array,["display","select",["options",$display_options],["direct_save","1"],["same","N"]]);
...
array_push($add_array,["organization","소속기관","필수","text"]);

...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["근무지명","office","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
  ...
  $keyword_column_array_selected = "office";      //기본 선택옵션 value
...
array_push($th_info,["office_idx","고유번호"]);
array_push($th_info,["office","근무지명"]);
...
array_push($css_array,["office_idx",["width","100px"]]);
...
array_push($edit_array,["office","text",["direct_save","1"]]);
...
array_push($add_array,["office","근무지","필수","text"]);

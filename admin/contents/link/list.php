<?
$folder_name = "link";  //폴더명
$title = "관련자료링크";


$table_name =$db_admin.".link_list";
$key_column_name ="link_idx";
...
//   array_push($keyword_column_array,["관리자명","manager","like"]);
   //array_push($keyword_column_array,["품목(일치)","title","="]);
   array_push($keyword_column_array,["타이틀","title","like"]);
...
array_push($th_info,["link_idx","고유번호"]);
array_push($th_info,["title","타이틀"]);

array_push($th_info,["url_link","url"]);
//array_push($th_info,["error_amount",""]);
// array_push($th_info,["exec_defective_rate","불량율"]);
...
array_push($edit_array,["title","text",["direct_save","1"]]);

array_push($edit_array,["url_link","text",["direct_save","1"]]);
...
array_push($add_array,["url_link","URL","필수","text"]);
...
function datatableRender(column,data,full){
  ...
  switch (column) {
    ...
    case "title":
          ...
          rValue = "<a href='"+full.url_link+"' target='_blank'>"+data+"</a>";

          break;

    case "url_link":
          
          rValue = "<a href='"+data+"' target='_blank'>"+data+"</a>";

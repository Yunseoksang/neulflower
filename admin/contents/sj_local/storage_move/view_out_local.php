...
$title ="[".$admin_info['t_storage_sangjo']."] 이동출고";
...
$main_filter_query = " (storage_idx='".$admin_info['storage_sangjo']."' and  part='이동출고' and io_status = '미출고'   )";  //and DATEDIFF(now(),receive_date) < 1
...
function datatableRender(column,data,full){
  ...
  switch (column) {
    ...
    case "io_status":
        rValue = '<button type="button" class="btn btn-danger btn_io_status"  next_io_status="이동출고완료">미출고</button>';

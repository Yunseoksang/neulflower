...
$folder_name = "sj_local/storage_move";  //폴더명
$title ="[".$admin_info['t_storage_sangjo']."] 이동내역";
...
$main_filter_query = " (storage_idx='".$admin_info['storage_sangjo']."' and  ((part='이동출고' and io_status='이동출고완료')  or (part='이동입고' and io_status='이동입고완료')) )";

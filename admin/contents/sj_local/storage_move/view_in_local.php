...
$title ="[".$admin_info['t_storage_sangjo']."] 이동입고";
...
$main_filter_query = " (storage_idx='".$admin_info['storage_sangjo']."' and  part='이동입고' and io_status = '미입고'   )";  //and DATEDIFF(now(),receive_date) < 1
...
function datatableRender(column,data,full){
  ...
  switch (column) {
    ...
    case "regist_datetime":
        ...
        break;
    case "io_status":
        rValue = '<button type="button" class="btn btn-warning btn_io_status" next_io_status="이동입고완료">미입고</button>';

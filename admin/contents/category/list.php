...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["카테고리명","category2_name","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
...
array_push($th_info,["category2_name","카테고리"]);
...
array_push($add_array,["category2_name","카테고리명","필수","text"]);
...
?>
  ...
  <div id="input_sample" class="hide">
    ...
    <div class="category2_idx edit">
      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
        <select class="select2_single form-control"  same="N" tabindex="-1" name="category2_idx" style="display: none;">
    ...
    <div class="category2_idx view">
        <span class="input" name="category2_idx" same="N"></span>
    </div>

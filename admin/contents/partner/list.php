<?
$folder_name = "partner";  //폴더명
$title ="파트너 목록";

$table_name ="partner";
$key_column_name ="partner_idx";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["상호","company_name","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
  // array_push($keyword_column_array,["브랜드IDX","brand_idx","="]);
  array_push($keyword_column_array,["담당자명","manager_name","like"]);
  array_push($keyword_column_array,["사업자번호","biz_no","like"]);
  array_push($keyword_column_array,["전화번호","phone","like"]);
  array_push($keyword_column_array,["휴대폰","mobile","like"]);
...
array_push($th_info,["partner_idx","고유번호"]);
array_push($th_info,["company_name","상호"]);
array_push($th_info,["partner_status","승인단계"]);


array_push($th_info,["manager_name","담당자"]);

array_push($th_info,["biz_no","사업자번호"]);
array_push($th_info,["phone","전화번호"]);
array_push($th_info,["mobile","휴대폰"]);
array_push($th_info,["email","이메일"]);
...
array_push($edit_array,["company_name","상호","필수","text"]);
array_push($edit_array,["biz_no","사업자번호","","text"]);

array_push($edit_array,["manager_name","담당자명","필수","text"]);
array_push($edit_array,["phone","전화","필수","text"]);

array_push($edit_array,["mobile","휴대폰","필수","text"]);
array_push($edit_array,["email","이메일","","text"]);

$partner_status_array = make_options_array("승인:승인/승인대기:승인대기/승인거절:승인거절/탈퇴:탈퇴");
array_push($edit_array,["partner_status","select",["options",$partner_status_array],["direct_save","1"],["same","Y"]]);
...
// array_push($add_array,["admin_level","소속","","select",[["본사","본사","SELECTED"],["서산공장","서산공장"],["개발팀","개발팀"]]]); //DB column 기준이라서 brand_name 이 아니고,brand_idx로,

array_push($add_array,["company_name","상호","필수","text"]);
array_push($add_array,["manager_name","담당자명","필수","text"]);
array_push($add_array,["biz_no","사업자번호","","text"]);
array_push($add_array,["phone","전화번호","필수","text"]);
array_push($add_array,["mobile","휴대폰","필수","text"]);
array_push($add_array,["email","이메일","필수","text"]);
...
?>
  ...
  <div id="input_sample" class="hide">
    ...
    <input name="brand_name" class="brand_name form-control">
    <!--input type=text name="menu_original_price" format="number"  class="menu_original_price form-control">-->


    <div class="category_idx edit">
      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
        <select class="select2_single form-control"  same="N" tabindex="-1" name="category_idx" style="display: none;">
    ...
    <div class="category_idx view">
        <span class="input" name="category_idx" same="N"></span>
    </div>

    
    <select name="is_show_seller" same="N" class="is_show_seller form-control direct_save">
        <option value="1">매입중</option>
        <option value="0">매입중지</option>
    </select>


    <select name="is_show_buyer" same="N" class="is_show_buyer form-control direct_save">

...
array_push($th_info,["product_idx","상품고유번호"]);
array_push($th_info,["product_img_url","상품이미지","img",[ ["unique_idx","product_idx"],["img_title","product_name"],["width","100"] ]   ]);

array_push($th_info,["t_category_name","카테고리"]);

array_push($th_info,["product_name","상품명"]);
array_push($th_info,["product_price","가격"]);

array_push($th_info,["order_cnt","주문수량"]);
...
array_push($add_array,["product_name","상품명","필수","text"]);
...
array_push($add_array,["product_img_url","상품이미지","","image"]);

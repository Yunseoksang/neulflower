...
/** 키데이터 중복여부 체크 */
$sel = mysqli_query($dbcon, "select * from product where category_idx='".$_POST['category_idx']."' and product_name='".$_POST['product_name']."' ") or die(mysqli_error($dbcon));
$sel_num = mysqli_num_rows($sel);

if ($sel_num > 0) {
    error_json(0,"이미 등록되어있는 상품 입니다.");
    exit;
}
/** 키데이터 중복여부 체크 시작 끝 */
...
$result = array();
$result['status'] = 1;
$result['data'][$key_column_name]=$category_idx;

...
$folder_name = "admin_list/admin_login_history";  //폴더명
$title ="관리자 로그인 이력";

$table_name =$db_admin.".admin_login_history";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["관리자명","admin_name","like","join",[$db_admin.".admin_list"],["admin_idx"]]);
  array_push($keyword_column_array,["관리자아이디","admin_id","like","join",[$db_admin.".admin_list"],["admin_idx"]]);
  array_push($keyword_column_array,["소속","t_storage_name","like","join",[$db_admin.".admin_list"],["admin_idx"]]);
...
array_push($th_info,["admin_login_history_idx","고유번호"]);
...
$other_table_column = "a:admin_idx:".$db_admin.".admin_list:admin_id+admin_name+t_storage_name"; //메인테이블이 아닌 다른 테이블에서 join을 통해 가져와야 하는 칼럼 => sorting 할때 뒤쪽에 붙여야 함.

...
$main_sql = "select a.*,`pm_super`, `pm_fullfillment`, `pm_sangjo`, `pm_flower`, `pm_consulting`, `pm_statistics`, `storage_super`, `t_storage_super`, `storage_fullfillment`, `t_storage_fullfillment`, `storage_sangjo`, `t_storage_sangjo`, `storage_flower`, `t_storage_flower`, `storage_consulting`, `t_storage_consulting`, `storage_statistics`, `t_storage_statistics` from ".$db_admin.".admin_list a left join ".$db_admin.".admin_permission b on a.admin_idx=b.admin_idx where 1=1 ";
$main_sql_cnt = "select count(*) as cnt from ".$db_admin.".admin_list a left join ".$db_admin.".admin_permission b on a.admin_idx=b.admin_idx where 1=1 ";
...
$sql_all_no_limit = $sql_cnt.$sql_where_filter.$sql_where_sub.$sql_where_date;

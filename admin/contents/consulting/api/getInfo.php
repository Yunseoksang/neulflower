...
$sel = mysqli_query($dbcon, "select *,date_format(contract_date,'%Y-%m') as contract_date_ym from consulting where consulting_idx='".$_POST['consulting_idx']."' ") or die(mysqli_error($dbcon));

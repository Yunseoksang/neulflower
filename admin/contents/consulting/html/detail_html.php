...
<table class="table table-bordered table_company_key_info"  consulting_idx="<?=$_REQUEST['consulting_idx']?>">
    ...
    <thead>
        <tr>
            <th colspan="7" class="company_name big_title">거래처를 선택해주세요</th>
        </tr>
    </thead>
    ...
    <tbody>
        <tr  class="tr_title">
            <th>계약상태</th>
            <th class="not_sp">상시근로자수</th>
            <!-- <th>미고용</th> -->
            <th class="not_sp">고용부담금</th>
            <th>거래품목</th>
            <!-- <th>거래가능품목</th> -->
            <th>계약일</th>
            <th>-</th>
        ...
        <tr class="tr_value">
            <td class="consulting_status">-</td>
            <td class="employees not_sp">-</td>
            <!-- <td class="unemployed">-</td> -->
            <td class="employment_fee not_sp">-</td>
            <td class="trading_items">-</td>
            <!-- <td class="tradeable_items">-</td> -->
            <td class="contract_date">-</td>
...
<table class="table table-bordered table_company_info">
    ...
    <tbody>
        ...
        <tr>
            <th scope="row" class="mth">본사여부</th>
            <td class="office_type"></td>
            <th scope="row" class="mth">본사명</td>
            <td class="head_office"></td>
        </tr>
...
<table class="table table-bordered table_manager_info" id="table_manager_info">

    <thead>
        <tr>
            <th colspan="10" class="manager_info mtitle">담당자정보
                <div class="navbar-right btn_manager_plus" style="text-align:right; padding-right:0px; font-size:11pt; cursor:pointer;">
        ...
        <tr class="hide_tr">
            <th scope="row" class="mth manager_th_mananger_id">아이디</th>
            ...
            <th scope="row" class="mth_x td_edit">. . .</th>
    ...
    <tbody>
        <tr class="hide_tr">
            <td class="manager_id"></td>
            <td class="item_in_charge"></td>
            ...
            <ul class="nav navbar-right panel_toolbox" style="min-width:unset;">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-ellipsis-v" style="color:#00b8ff;"></i></a>
                <ul class="dropdown-menu" role="menu" >
                  <li><a href="javascript:" class="manger_del">삭제</a>
                  </li>
                  <li><a href="javascript:" class="manager_edit">수정</a>
                  </li>
                </ul>
              </li>
                    ...
                    <div class="block">
                        ...
                        <a href="javascript:" class="tag">
                            <span class="memo_status">상조용품</span>
                                        ...
                                        영업일: <input placeholder='영업일' type='date' class='mdate' name='date1'  value="<?=date('Y-m-d')?>"><br>
            ...
            <div class="x_panel x_panel_memo_history">
                ...
                <li id="memo_add_section" class="hide">
                    <div class="block">
                        ...
                        영업일: <input placeholder='영업일' type='date' class='mdate' name='date2' value="<?=date('Y-m-d')?>"><br>
                        <div class="form-group" >
            ...
            <td class="td_edit">
              ...
              <ul class="nav navbar-right panel_toolbox" style="min-width:unset;">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-ellipsis-v" style="color:#00b8ff;"></i></a>
                  <ul class="dropdown-menu" role="menu" >
                    <li><a href="javascript:" class="manager_del">삭제</a>
                    </li>
                    <li><a href="javascript:" class="manager_edit">수정</a>
                    </li>
                  </ul>
...
<div id="manager_info_sample" class="hide">
    <table>
        <tr>
            ...
            <td class="td_edit"><i class="fa fa-close" title="닫기"></i> <i class="fa fa-save hide" title="저장"></i><i class="fa fa-undo hide" title="취소"></i></td>

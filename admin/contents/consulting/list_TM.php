...
array_push($th_info,["regist_datetime","최초컨택"]);
array_push($th_info,["update_datetime","최근컨택"]);

array_push($th_info,["company_name","업체명"]);
array_push($th_info,["manager","담당자"]);

array_push($th_info,["address","주소"]);


array_push($th_info,["employees","업체현황"]);
...
function datatableRender(column,data,full){
  ...
  switch (column) {
    ...
    case "employees":
          rValue = "상시:"+data;
          rValue += "<br>미고용:"+full.unemployed;
          rValue += "<br>부담금:"+full.employment_fee;
          break;

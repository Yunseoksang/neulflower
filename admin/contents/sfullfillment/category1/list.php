...
$folder_name = "sfullfillment/category1";  //폴더명
$title ="대분류 관리";

$table_name ="fullfillment.category1";
$key_column_name ="category1_idx";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["대분류","category1_name","like"]);   
  ...
  $keyword_column_array_selected = "category1_name";      //기본 선택옵션 value
...
array_push($th_info,["category1_idx","고유번호"]);

array_push($th_info,["category1_name","대분류"]);
...
array_push($edit_array,["category1_name","대분류","필수","text"]);
...
array_push($add_array,["category1_name","대분류","필수","text"]);
...
// array_push($add_array,["product_price","기본가격","필수","number"]);

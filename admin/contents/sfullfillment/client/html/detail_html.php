        ...
        <tr class="new_tr">
            <td class="product_name">
                        <select id="new_product" name="product_idx" class="select2_single form-control" tabindex="-1" style="display: none;">
                            ...
                            $sel_product = mysqli_query($dbcon, "select product_idx,product_name,product_price from ".$db_fullfillment.".product where display='on' order by product_name ") or die(mysqli_error($dbcon));

...
if($_POST['mode'] == "manager_set"){
    ...
    if($_POST['sm_idx'] != "undefined" && $_POST['sm_idx'] != ""){ //담당자 수정
        ...
        if($_POST['new_manager_idx'] == "" || $_POST['new_manager_idx'] == "0"  || $_POST['new_manager_idx'] == "undefined" ){
            ...
            $del = mysqli_query($dbcon, "delete from fullfillment.settlement_manager where sm_idx='".$_POST['sm_idx']."' ") or die(mysqli_error($dbcon));
            ...
            $up = mysqli_query($dbcon, "update fullfillment.settlement_manager
            set 
        ...
        $in = mysqli_query($dbcon, "insert into fullfillment.settlement_manager
            set 
    ...
    if ($sel_num == 0) { //기존에 회사소속 매니저 목록에 없으면 추가하기
        ...
        if (intval($_POST['fs_idx']) > 0) {
            if($_POST['new_sdate'] == "미지정" || $_POST['new_sdate'] == ""  || $_POST['new_sdate'] == "0" || $_POST['new_sdate'] == "undefined" ){
                $del = mysqli_query($dbcon, "delete from fullfillment.settlement_sdate where fs_idx='".$_POST['fs_idx']."' ") or die(mysqli_error($dbcon));
                $del_num = mysqli_affected_rows($dbcon);
                if($del_num > 0){ //쿼리 성공 // 0이면 쿼리성공이지만 변경데이터 없음.
                    $result = array();
                    $result['status'] = 1;
                ...
                $up = mysqli_query($dbcon, "update fullfillment.settlement_sdate 
                set 
            ...
            if($_POST['new_sdate'] == "미지정" || $_POST['new_sdate'] == ""  || $_POST['new_sdate'] == "0" || $_POST['new_sdate'] == "undefined" ){
                ...
                $sel_sdate = mysqli_query($dbcon, "select * from fullfillment.settlement_sdate where category1_idx='".$_POST['category1_idx']."' and
                consulting_idx ='".$_POST['consulting_idx']."'
                ...
                if ($sel_sdate_num == 0) {
                    ...
                    $in = mysqli_query($dbcon, "insert into fullfillment.settlement_sdate
                    set 

...
$(document).ready(function(){
    ...
    $(document).on("click",".btn_add_client",function(){
        window.location.href="?page=fullfillment/client/input";
    });
   ...
   $(document).on("click",".place_edit",function(){
    ...
    $(document).on("click","li.memo_li span.memo_status",function(){
        ...
        var url = "./contents/sfullfillment/client/api/updateCell.php";
    ...
    $(document).on("click",".btn_save_history",function(){
        ...
        var url = "./contents/sfullfillment/client/api/insertMemo.php";
...
/*
    ...
    $(document).on("click","#datatable-main td.company_name",function(){
        ...
        var url = "./contents/sfullfillment/client/api/getInfo.php";
        var consulting_idx = $(this).closest("tr").attr("consulting_idx");
...
function ajaxFileUpload() {
    ...
    var url = "./contents/sfullfillment/client/api/uploadFile.php";
...
function delete_attach($obj){
    ...
    var url = "./contents/sfullfillment/client/api/uploadFile_del.php";
...
function save_place($table,mode){
    ...
    var url = "./contents/sfullfillment/client/api/saveClientPlace.php";
...
function save_product($obj,mode){
    ...
    var url = "./contents/sfullfillment/client/api/saveClientProduct.php";
...
function saveCategoryManager($obj,mode){
        ...
        if(mode == "manager_set"){
            ...
            var url = "./contents/sfullfillment/client/api/saveCategoryManager.php";
    ...
    $.ajax( { 
        ...
        success: function(result){
            ...
            if(result_status == 1)
            {
                ...
                if(mode == "manager_set"){
                    if(result.data.type == "11"){ //담당자 미선택으로 변경성공, delete from fullfillment.settlement_manager
                        $tr.removeAttr("sm_idx");

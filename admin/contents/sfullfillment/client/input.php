...
if($_REQUEST['consulting_idx'] != ""){
    $sel_con = mysqli_query($dbcon, "select * from client where consulting_idx='".$_REQUEST['consulting_idx']."' ") or die(mysqli_error($dbcon));
...
<link href="contents/sfullfillment/client/css/input.css?ver=<?=time()?>" rel="stylesheet" type="text/css" />
<script src="contents/sfullfillment/client/js/input.js?ver=<?=time()?>"></script>

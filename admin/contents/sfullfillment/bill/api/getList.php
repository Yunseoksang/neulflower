...
(select * from fullfillment.out_order_client_product 
...
left join fullfillment.in_out d
on a.oocp_idx=d.oocp_idx

left join fullfillment.settlement_sdate e
on a.consulting_idx=e.consulting_idx and a.category1_idx=e.category1_idx

left join fullfillment.settlement_manager f

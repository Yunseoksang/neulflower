...
$(document).ready(function(){
    ...
    $(document).on("click",".btn_print_detail",function(event){
        ...
        window.open("dashboard_print.php?page=sfullfillment/bill/print_bill&fn=statistics/fu_cnst_m&mode=detail&cidx="+consulting_idx+"&yyyymm="+yyyymm,"거래내역상세","width=1000,height=800,top=100,left=100");
    });
...
function  view_popup(bill_idx,consulting_idx,category1_idx,yyyymm,mode){
    ...
    var url = "./contents/sfullfillment/bill/api/getMonthlyConsultingDetail.php";
...
function saveBill(consulting_idx,category1_idx,yyyymm,oocp_idx_list,totalSum){
    ...
    var url = "./contents/sfullfillment/bill/api/saveBill.php";
...
function  view_bill(bill_idx){
    ...
    var url = "./contents/sfullfillment/bill/api/getMonthlyConsultingBill.php";
...
function reset_filter(){
    ...
    //var url = "./contents/sfullfillment/bill/api/getList.php";
...
function updateBill($obj,mode)
{
    ...
    var url = "./contents/sfullfillment/bill/api/updateBill.php";
...
function sendBill($obj,mode){
    ...
    var url = "./contents/sfullfillment/bill/api/sendBill.php";

        ...
        <div class="right_set" mode='plus'>
          <div class="page-title">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 form-group pull-right" style="text-align:right;">
                      <a href='contents/sfullfillment/storage/api/getSpreadSheet.php'><button type="button" class="btn btn-primary btn_excel_download">엑셀 다운로드</button></a>
            </div>
          </div>
                    ...
                    for ($i=0;$i<count($product_arr);$i++ )
                    {
                      ...
                      ?>
                        <tr class="<?=$line_class?> pointer">
                            ...
                            <td class=" "><a href="?page=sfullfillment/storage_adjust/history&product_idx=<?=$product_arr[$i]['product_idx']?>" target="history"><?=$product_arr[$i]['product_name']?></a></td>
...
?>
                            ...
                            <!-- <td class=" "><a href="?page=sfullfillment/storage_product/list" target="product"><?=$product_arr[$i]['memo']?></td> -->
...
<?
                            ...
                            for ($k=0;$k<count($storage_arr);$k++)
                            {
                              ...
                              ?>
                                    <td class=" <?=$safe_alert?>" title="<?=$title_alt?>"><a href="dashboard_sffm.php?page=sfullfillment/storage_input/move&storage_idx=<?=$storage_arr[$k]['storage_idx']?>" target="move"><?=$storage_safe_arr[$storage_column][$product_column][1]?><?=$safe_num_w?><?=$in_sum?></a></td>
                            <?}
                            ?>

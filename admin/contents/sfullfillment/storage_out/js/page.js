...
$(document).ready(function(){
    ...
    $(document).on("click",".btn_download_xls_list",function(){
        ...
        if($("#btn_search_refresh").hasClass("btn-danger")){
            ...
            window.location.href="./contents/sfullfillment/storage_out/api/download_xls.php?mode=list&sdate="+sdate+"&edate="+edate;

        }else{
            //toast("준비중입니다");
            window.location.href="./contents/sfullfillment/storage_out/api/download_xls.php?mode=list";
    ...
    $(document).on("click",".btn_download_xls_view_delivery",function(){
        ...
        //toast("준비중입니다");
        window.location.href="./contents/sfullfillment/storage_out/api/download_xls.php?mode=view_delivery";

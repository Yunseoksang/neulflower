...
$main_filter_query = "part='출고' and (io_status='출고취소' or io_status='주문취소') ";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["풍목","t_product_name","like"]);  
  array_push($keyword_column_array,["풍목(일치)","t_product_name","="]);  
...
array_push($th_info,["regist_datetime","등록일"]);
array_push($th_info,["cancel_datetime","취소일"]);
...
//array_push($css_array,["regist_datetime",["min-width","50px"]]);
///array_push($css_array,["update_datetime",["min-width","130px"]]);
array_push($css_array,["exec",["min-width","50px"]]);

array_push($css_array,["io_status",["min-width","50px"]]);

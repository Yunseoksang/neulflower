...
$(document).ready(function(){
    ...
    $(document).on("click",".btn_barcode",function(e){
        ...
        window.open('/admin/contents/barcode/barcode_frame.php?part=sffm&product_idx='+product_idx, '_blank', '', '');
    });
    ...
    $(document).on("change","#modal_add select[name='category1_idx']",function(e){
        ...
        var url = "./contents/sfullfillment/storage_product/api/getCategory2.php";
    ...
    $(document).on("change","#datatable-main select[name='category1_idx']",function(e){
        ...
        $.ajax( { 
                ...
                success: function(result){
                    ...
                    if(result_status == 1)
                    {
                        ...
                        var $ct2 = $tr.find("select[name='category2_idx']");
                        ...
                        if(category2_list.length == 0){
                            ...
                            $ct2.html("");
                            $ct2.append("<option value='' base_price=''>- 선택 -</option>");
                            ...
                            var old_value = $tr.find("td.category2_idx").attr("category2_idx");
                                    // Set the initial value of select2
                            if (old_value) {
                                $ct2.val(old_value).trigger('change');
                            }

...
$part_code = substr($_REQUEST['qrcode'],6,2); // 01=sangjo, 02=fullfillment  , 03=flower
...
$product_idx = (int) substr($_REQUEST['qrcode'],8,5); // 01=sangjo, 02=fullfillment  , 03=flower

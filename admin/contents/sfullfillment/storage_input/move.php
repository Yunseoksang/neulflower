...
$folder_name = "sfullfillment/storage_input";
          ...
          <div class="page-title">
            ...
            <div class="title_right">
              <div class="col-md-8 col-sm-8 col-xs-12 form-group pull-right">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12 storage_from_div" >
                          
                          <select id="storage_from" class="select2_single form-control" tabindex="-1" style="display: none;">
                          ...
                          if ($sel_storage_num > 0) {
                            while($data_storage = mysqli_fetch_assoc($sel_storage)) {
                              ...
                              <option value="<?=$data_storage['storage_idx']?>" <? if($data_storage['storage_idx'] == $_REQUEST['storage_idx']){echo "selected='selected'";}?>><?=$data_storage['storage_name']?></option>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-12 ">
                              <i class="fa fa-long-arrow-right storage_arrow"></i>
                        </div>

                        <div class="col-md-5 col-sm-5 col-xs-12 storage_to_div ">
                          <select id="storage_to" class="select2_single form-control" tabindex="-1" style="display: none;">
                             <option>도착지</option>
                          <?php
                          mysqli_data_seek($sel_storage,0);
                          if ($sel_storage_num > 0) {
                            while($data_storage = mysqli_fetch_assoc($sel_storage)) {?>
...
$arr['storage_idx'] = "2"; //서산공장

if($_REQUEST['storage_idx'] != ""){
  $arr['storage_idx'] = $_REQUEST['storage_idx']; 

}


require('./contents/sfullfillment/storage_input/api/common.php');
$sel_product = mysqli_query($dbcon, $base_output_product_query) or die(mysqli_error($dbcon));
    ...
    ?>
                      ...
                      <li product_idx="<?=$data_product['product_idx']?>">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right">
                                ...
                                <br class="<?=$soc_class?>">
                                <span class='plus_storage_cnt_minus <?=$soc_class?>'>-<?=$data_product['sum_in_count']?></span>
...
?>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12  right ">
              ...
              <button  class="btn btn-success btn_save_move">이동하기</button>
            </div>

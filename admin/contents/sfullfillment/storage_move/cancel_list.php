...
$main_filter_query = " ( part='이동출고' and io_status = '이동출고취소'  )";  //and DATEDIFF(now(),receive_date) < 1
...
function datatableRender(column,data,full){
  ...
  switch (column) {
    ...
    case "regist_datetime":
        ...
        break;
    // case "io_status":
    //     rValue = '<button type="button" class="btn btn-danger btn_io_status" next_io_status="이동출고완료">'+data+'</button>';

...
$function_add_html = "<input type='text' class='form-control hide' id='barcode_input_all' placeholder='QR이동출고' style='width:150px; float:right;'>";
  ...
  switch (column) {
    ...
    case "io_status":
      ...
      case "exec_td":
        ...
        rValue += '<br><button type="button" class="btn btn-primary btn_io_status_cancel" next_io_status="이동출고취소">취소하기</button>';

...
$(document).ready(function(){
    ...
    */
    ...
    $(document).on("click",".btn_download_xls_moveout",function(){
        ...
        //toast("준비중입니다");
        window.location.href="./contents/sfullfillment/storage_move/api/download_xls.php?mode=moveout";
    ...
    $(document).on("click",".btn_download_xls_movein",function(){
        ...
        //toast("준비중입니다");
        window.location.href="./contents/sfullfillment/storage_move/api/download_xls.php?mode=movein";
    ...
    $(document).on("click", ".btn_io_status",function() {
        ...
        var url = "./contents/sfullfillment/storage_move/api/updateCell.php";

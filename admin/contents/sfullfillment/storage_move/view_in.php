...
$folder_name = "sfullfillment/storage_move";  //폴더명
$title ="이동입고현황";
...
$function_add_html = "<input type='text' class='form-control hide' id='barcode_input_all' placeholder='QR이동입고' style='width:150px; float:right;'>";

...
$folder_name = "sfullfillment/storage_in";  //폴더명
$title ="이동 내역";
...
$main_filter_query = " ( (part='이동출고' and io_status='이동출고완료' )  or (part='이동입고' and io_status='이동입고완료'))";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["품목명","t_product_name","like"]);
  array_push($keyword_column_array,["품목명(일치)","t_product_name","="]);
  ...
  switch (column) {
    ...
    case "io_status":
      if(data == "이동출고완료"){
        ...
        if(full.qr_moveout_datetime == undefined || full.qr_moveout_datetime == "" || full.qr_moveout_datetime == null){
          rValue = '<button type="button" class="btn btn-success" >'+data+'</button>';
        }else{
          rValue = '<button type="button" class="btn btn-success" >'+data+'(QR)</button>';

        }

        }else if(data == "이동입고완료"){
        if(full.qr_movein_datetime == undefined || full.qr_movein_datetime == "" || full.qr_movein_datetime == null){
          rValue = '<button type="button" class="btn btn-primary" >'+data+'</button>';
        }else{
          rValue = '<button type="button" class="btn btn-primary" >'+data+'(QR)</button>';

  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel m_x_panel">
          
          
          
          <?
            if( isset( $title_bar_ratio) && $title_bar_ratio  == ""){
              if($function_add == "on" || $functionA_add_custom != ""){ //새로추가하기 버튼 있으면
            ...
            switch ($mm)
            {
                ...
                case "select2":?>
                  ...
                  case "selectDropDown":?>
                    ...
                    <button type="button" class="io_status btn btn-primary"  value="<?=$options[0][0]?>"><?=$options[0][1]?></button>
...
<div id="hidden_qr" style="display:none;">
    <div id="container">

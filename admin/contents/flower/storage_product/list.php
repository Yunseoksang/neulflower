...
array_push($th_info,["t_category2_name","중분류"]);


array_push($th_info,["product_name","제품명"]);
array_push($th_info,["options","옵션"]);
...
array_push($th_info,["is_vat","부가세적용품목","convert",[    ["1","적용"],["0","비적용"]    ] ]);
...
array_push($edit_array,["is_vat","select",["options",[["0","비적용"],["1","적용"]]],["direct_save","1"],["same","N"]]);

array_push($edit_array,["display_order","노출순서","","number"]);
array_push($edit_array,["display_group","담당자","","text"]);

array_push($edit_array,["options","옵션","","textarea"]);
...
// array_push($add_array,["product_price","납품단가","","number"]);
  ...
  switch (column) {
    ...
    case "product_price":
        if (data == ""){
          ...
          rValue = parseInt(data).toLocaleString();
        }
        break;

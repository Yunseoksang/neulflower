    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel m_x_panel  col-md-6 col-sm-6 col-xs-6">
          ...
          ?>
          <div class="x_title col-md-2 col-sm-2 col-xs-12 ">
          ...
          <div class="row tile_count  col-md-10 col-sm-10 col-xs-12">
            <!-- <div class="animated flipInY col-md-1 col-sm-1 col-xs-1 tile_stats_count">

            </div> -->
            <div class="animated flipInY col-md-2 col-sm-2 col-xs-2 tile_stats_count">

            </div>
            <div class="animated flipInY col-md-1 col-sm-1 col-xs-1 tile_stats_count">
              <div class="left"></div>
              <div class="right">
                <span class="count_top"><i class="fa fa-truck"></i> 당일배송건</span>
                <div class="count today_count"><a href="dashboard_flower.php?page=flower/board/list&st=1" id="today_count"></a></div>
              </div>
            </div>
            <div class="animated flipInY col-md-1 col-sm-1 col-xs-1 tile_stats_count">
              <div class="left"></div>
              <div class="right">
                <span class="count_top"><i class="fa fa-clock-o"></i> 예약건</span>
                <div class="count"><a href="dashboard_flower.php?page=flower/board/list&st=2" id="reserved_count"></a></div>
              </div>
            </div>
            <div class="animated flipInY col-md-1 col-sm-1 col-xs-1 tile_stats_count">
              <div class="left"></div>
              <div class="right">
                <span class="count_top"><i class="fa fa-spinner"></i> 미배송건</span>
                <div class="count"><a href="dashboard_flower.php?page=flower/board/list&st=3" id="ready_count"></a></div>
              </div>
            </div>
            ...
            <div class="animated flipInY col-md-2 col-sm-2 col-xs-2 tile_stats_count">
              <div class="left"></div>
              <div class="right">
                <span class="count_top"><i class="fa fa-th-large"></i> 금일수주</span>
                <div class="count green" ><a href="dashboard_flower.php?page=flower/board/list&st=6" id="today_order_count"></a></div>
              </div>
            </div>
            <div class="animated flipInY col-md-1 col-sm-1 col-xs-1 tile_stats_count">
              <div class="left"></div>
              <div class="right">
                <span class="count_top"><i class="fa fa-th-large"></i> 금월수주</span>
                <div class="count green" ><a href="dashboard_flower.php?page=flower/board/list&st=7" id="this_month_order_count"></a></div>
              </div>
            </div>
            <div class="animated flipInY col-md-3 col-sm-3 col-xs-3 tile_stats_count">
              <div class="left"></div>
              <div class="right">
                <span class="count_top"><i class="fa fa-krw"></i> 총수주금액</span>
                <div class="count green" id="total_client_price_sum"></div>
              </div>
            </div>

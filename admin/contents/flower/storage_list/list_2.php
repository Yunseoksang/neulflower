...
$main_filter_query = " storage_type='협력사' ";
...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["협력사명","storage_name","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
...
array_push($th_info,["storage_name","협력사명"]);
...
array_push($edit_array,["storage_type","select",["options",$seller_options],["direct_save","1"],["same","N"]]);
...
array_push($add_array,["storage_name","협력사","필수","text"]);
array_push($add_array,["storage_type","","","hidden","협력사"]);

...
if($function_keyword_search == "on"){
  ...
  array_push($keyword_column_array,["지점명","storage_name","like"]);   //로딩시 첫 옵션 기본선택됨. dataTables.ajax.button.js 에서 keyword_query = setKeywordQuery(0); 에 의해 첫번째 옵션이 기본옵션으로 선택됨.
...
array_push($th_info,["storage_name","지점명"]);
...
array_push($add_array,["storage_name","지점","필수","text"]);
array_push($add_array,["storage_type","","","hidden","지점"]);

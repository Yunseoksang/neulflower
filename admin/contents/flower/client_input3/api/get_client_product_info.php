...
select 'sangjo' as product_part,display_order,consulting_idx,
product_idx,product_name,'' as options,
'0' as client_product_idx,
'0' as client_price_sum,
'0' as client_price,'0' as client_price_tax 
from sangjo.product 

...
$sel_client = mysqli_query($dbcon, "select * from ".$db_consulting.".consulting order by company_name ") or die(mysqli_error($dbcon));
            ...
            <div class="x_panel x_panel_minium">
              ...
              <div class="x_content ">
                <div class="" id="out_form">
                        ...
                        <input type="text" id="sender_name" class="form-control input_normal" name="sender_name" >

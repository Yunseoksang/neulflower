...
$folder_name = "sfullfillment_local/storage_out";  //폴더명
$title ="[".$admin_info['t_storage_fullfillment']."] 출고내역";
...
$main_filter_query = "storage_idx='".$admin_info['storage_fullfillment']."' and part='출고' and io_status = '출고완료' ";
...
function datatableRender(column,data,full){
  ...
  switch (column) {
    ...
    case "regist_datetime":
        ...
        break;
    case "io_status":
        rValue = '<button type="button" class="btn btn-primary btn_io_status" >'+data+'</button>';

...
function saveClientOrderUpload(dataArray){
    ...
    var url = "./contents/sfullfillment/client_input/api/save_client_order_upload.php";
...
function load_client_product(consulting_idx){
    ...
    var url = "./contents/sfullfillment/client_input/api/get_client_product_info.php";

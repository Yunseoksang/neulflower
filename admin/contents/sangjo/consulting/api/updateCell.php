...
if($_POST['mode'] == "consulting_status"){

    $up = mysqli_query($dbcon, "update consulting set consulting_status='".$_POST['consulting_status']."'  where consulting_idx='".$_POST['consulting_idx']."' ") or die(mysqli_error($dbcon));
    ...
    $del = mysqli_query($dbcon, "delete from consulting where consulting_idx='".$_POST['consulting_idx']."' ") or die(mysqli_error($dbcon));

...
for ($i=0;$i<count($product_list);$i++ )
{
    ...
    if($arr['move_check'] == 1){ //이동지시서 작성
        ...
        $sel = mysqli_query($dbcon, "select * from storage_safe where storage_idx='".$base_storage_idx."' and product_idx='".$product_list[$i]['product_idx']."'  ") or die(mysqli_error($dbcon));

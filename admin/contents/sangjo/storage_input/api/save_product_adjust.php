...
if($arr['mode'] == "empty"){ //재고없음 창고 처리
    ...
    $sel = mysqli_query($dbcon, "select * from storage_safe where storage_idx='".$arr['storage_idx']."' and product_idx='".$arr['product_idx']."' order by io_idx desc limit 1") or die(mysqli_error($dbcon));

...
$folder_name = "sangjo/out_order";  //폴더명
$title ="주문내역";

$table_name ="sangjo_new.out_order_client_product";  // DB명 추가
...
if($_REQUEST['mode'] == "order"){
    $main_filter_query = "oocp_status = '주문접수' ";
}else if($_REQUEST['mode'] == "cancel"){
  $main_filter_query = "oocp_status = '주문취소' ";
}
...
$other_table_column = "a:consulting_idx:".$db_consulting.".consulting:company_name";  //a:out_order_idx:out_order:to_place_name+to_address+to_name+to_hp+memo/

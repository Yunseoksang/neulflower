...
$folder_name = "sangjo/storage_adjust";  //폴더명
$title ="상품별 히스토리";
    ...
    case "t_storage_name":
        <? 
            if($_REQUEST['product_idx'] != ""){?>
                rValue = "<a href='?page=sangjo/storage_adjust/history&product_idx=<?=$_REQUEST['product_idx']?>&storage_idx="+full.storage_idx+"'>"+data+"</a>";

            <?}else{?>
                rValue = "<a href='?page=sangjo/storage_adjust/history&storage_idx="+full.storage_idx+"'>"+data+"</a>";
    ...
    case "t_product_name":
        <? 
            if($_REQUEST['storage_idx'] != ""){?>
                rValue = "<a href='?page=sangjo/storage_adjust/history&product_idx="+full.product_idx+"&storage_idx=<?=$_REQUEST['storage_idx']?>'>"+data+"</a>";

            <?}else{?>
                rValue = "<a href='?page=sangjo/storage_adjust/history&product_idx="+full.product_idx+"'>"+data+"</a>";

...
for ($i=0;$i<count($product_list);$i++ )
{
    ...
    admin_admin_memo = '".mysqli_real_escape_string($dbcon, $arr['memo'])."',
    ...
    if($in_id){//쿼리성공
        ...
        //안전재고 테이블 합계 저장 업데이트
        $in = mysqli_query($dbcon, "insert into storage_safe (storage_idx,product_idx,current_count) values ('".$arr['from_storage_idx']."','".$product_list[$i]['product_idx']."','".$next_count."')

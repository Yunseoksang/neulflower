...
".($_POST['display_order'] != "" ? ",display_order='".$_POST['display_order']."'" : "")."
".($_POST['display_group'] != "" ? ",display_group='".$_POST['display_group']."'" : "")."
".($_POST['unit'] != "" ? ",unit='".$_POST['unit']."'" : "")."
".($_POST['cost'] != "" ? ",cost='".$_POST['cost']."'" : "")."
".($_POST['specifications'] != "" ? ",specifications='".$_POST['specifications']."'" : "")."

...
//     $location = $_SERVER["DOCUMENT_ROOT"].'/upload/client/'.$name;
...
//$path = $_SERVER["DOCUMENT_ROOT"]."/upload/client/";
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {       
        ...
        $folder_idx = "/upload/client/".$_POST['consulting_idx'];
		...
		if(file_exists($absolute_path)){ 
            ...
            $local_name = "/upload/client/".$_POST['consulting_idx']."/".$new_name;
            $absolute_path = $_SERVER["DOCUMENT_ROOT"].$local_name;
        }

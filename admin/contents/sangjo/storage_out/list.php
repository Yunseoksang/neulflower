...
$other_table_column = "a:out_order_idx:sangjo_new.out_order:consulting_idx+t_company_name as company_name+to_place_name+to_address+to_name+to_hp+to_phone+receiver_name+delivery_memo"; //메인테이블이 아닌 다른 테이블에서 join을 통해 가져와야 하는 칼럼 => sorting 할때 뒤쪽에 붙여야 함.

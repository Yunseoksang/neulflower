...
if ($sel_bill_check_num > 0) {
   ...
   from
   (select *,date(regist_datetime) as order_date from sangjo_new.in_out where bill_idx='".$bill_idx."'
   ...
   if ($sel_num > 0) {
    ...
    from
    (select *,date(regist_datetime) as order_date from sangjo_new.in_out where consulting_idx='".$_POST['consulting_idx']."' and category1_idx='".$_POST['category1_idx']."' and part='출고' and io_status='출고완료' and 

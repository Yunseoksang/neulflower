...
/** 키데이터 중복여부 체크 */
$sel = mysqli_query($dbcon, "select * from brand where brand_name='".$_POST['brand_name']."' ") or die(mysqli_error($dbcon));
$sel_num = mysqli_num_rows($sel);

if ($sel_num > 0) {
    error_json(0,"이미 등록되어있는 브랜드명 입니다.");
    exit;
}
/** 키데이터 중복여부 체크 시작 끝 */

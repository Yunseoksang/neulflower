...
if($_POST['mode'] == "get"){
    ...
    if($_POST['permission_hrm']          != ""){  $set_sql .= "pm_hrm                 ='".$_POST['permission_hrm']."',";          }else{  $set_sql .= "pm_hrm                 =NULL,";}
    ...
    if($_POST['storage_hrm']             != ""){  $set_sql .= "storage_hrm            ='".$_POST['storage_hrm']."'";              }else{  $set_sql .= "storage_hrm     =NULL" ;}

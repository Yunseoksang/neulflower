...
$(document).ready(function(){
    ...
    $(document).on("click",".btn_modal_save",function(){
        ...
        var permission_hrm           = $("#select_permission_hrm          option:selected").val();
        ...
        var storage_hrm             = $("#select_storage_hrm      option:selected").val();
        ...
        console.log("permission_hrm          " + permission_hrm   );
        ...
        console.log("storage_hrm             " + storage_hrm             );
        ...
        if(permission_hrm           != "0"){str += "&permission_hrm="+permission_hrm;}
        ...
        if(storage_hrm              != "0"){str += "&storage_hrm="+storage_hrm;}
        ...
        var t_storage_hrm             = $("#select_storage_hrm             option:selected").text();
        ...
        if(permission_hrm         != "0"){
            result_pm += permission_hrm        + "<br>";
            if(t_storage_hrm            != "해당없음"){
                result_st += t_storage_hrm           + "<br>";
            }else{
                //result_st += "--<br>";
                window.alert('인사총무관리 > 소속지사를 선택해주세요');
                return;
        ...
        $.ajax( { 
                ...
                success: function(result){
                    ...
                    if(result_status == 1)
                    {
                        ...
                        $("#select_permission_hrm          option[value='"+admin_permission.pm_hrm+"']").prop('selected','selected');
                        ...
                        $("#select_storage_hrm          option[value='"+admin_permission.storage_hrm+"']").prop('selected','selected');

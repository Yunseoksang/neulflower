...
/*
$ccq1 = "select a.*,b.current_count as sum_current_count,b.zero_count,c.sum_out_count from product a
...
/*
$ddq1 = "select a.*,b.sum_current_count,b.zero_count,c.sum_out_count from product a
left join (
    select sum(current_count) as sum_current_count,zero_count,product_idx from (

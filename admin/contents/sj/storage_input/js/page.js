...
$(document).ready(function(){
    ...
    $(document).on("change","#barcode_input,#input_qrcode",function(el) {
        console.log("바코드1:"+$(el.target).val());
...
function select_li($li){
        ...
        if($li.find(".icheckbox_flat-green").hasClass("checked")){
            $li.find(".icheckbox_flat-green").removeClass("checked");
            $("ul.ul_product_list_right").find("li[product_idx='"+product_idx+"']").remove();
        }else{
            $li.find(".icheckbox_flat-green").addClass("checked");
...
function saveNew(dataArray){
    ...
    var url = "./contents/sj/storage_input/api/save_product_info.php";
...
function saveOutput(mode,dataArray,storage_idx){
    ...
    if(mode == "output"){
        var url = "./contents/sj/storage_input/api/save_product_output.php";

    }else if(mode == "move"){
        var url = "./contents/sj/storage_input/api/save_product_move.php";

    }else if(mode == "adjust"){
        var url = "./contents/sj/storage_input/api/save_product_adjust.php";

    }else if(mode == "safe"){
        var url = "./contents/sj/storage_input/api/save_storage_safe.php";
...
function load_product(storage_idx){
    ...
    var url = "./contents/sj/storage_input/api/get_product_info.php";
...
function load_safety(mode,storage_idx){
    ...
    var url = "./contents/sj/storage_input/api/get_storage_safe.php";
    var str = "mode="+mode+"&storage_idx="+storage_idx; //
...
function get_barcode_product(qrcode){
    ...
    var url = "./contents/sj/storage_input/api/get_barcode_product.php";

...
$folder_name = "sj/storage_adjust";  //폴더명
$title ="상품별 히스토리";
...
array_push($th_info,["t_to_storage_name","도착"]);

array_push($th_info,["product_idx","상품IDX"]);
...
array_push($th_info,["status_change_datetime","단계변경일"]);
...
array_push($css_array,["status_change_datetime",["min-width","130px"]]);
    ...
    case "t_storage_name":
        <? 
            if($_REQUEST['product_idx'] != ""){?>
                rValue = "<a href='?page=sj/storage_adjust/history&product_idx=<?=$_REQUEST['product_idx']?>&storage_idx="+full.storage_idx+"'>"+data+"</a>";

            <?}else{?>
                rValue = "<a href='?page=sj/storage_adjust/history&storage_idx="+full.storage_idx+"'>"+data+"</a>";
    ...
    case "t_product_name":
        <? 
            if($_REQUEST['storage_idx'] != ""){?>
                rValue = "<a href='?page=sj/storage_adjust/history&product_idx="+full.product_idx+"&storage_idx=<?=$_REQUEST['storage_idx']?>'>"+data+"</a>";

            <?}else{?>
                rValue = "<a href='?page=sj/storage_adjust/history&product_idx="+full.product_idx+"'>"+data+"</a>";

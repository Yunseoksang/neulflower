...
$main_filter_query = "part='출고' and io_status = '출고완료' ";
  ...
  switch (column) {
    ...
    case "io_status":
        if(full.qr_output_datetime == undefined || full.qr_output_datetime == "" || full.qr_output_datetime == null){
          rValue = '<button type="button" class="btn btn-dark btn_io_status" >'+data+'</button>';
        }else{
          rValue = '<button type="button" class="btn btn-primary btn_io_status" >'+data+'(QR)</button>';

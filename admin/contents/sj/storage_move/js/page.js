...
$(document).ready(function(){
    ...
    //toast("준비중입니다");
    window.location.href="./contents/sj/storage_move/api/download_xls.php?mode=moveout";
    ...
    $(document).on("click",".btn_download_xls_movein",function(){
        ...
        //toast("준비중입니다");
        window.location.href="./contents/sj/storage_move/api/download_xls.php?mode=movein";
    ...
    $(document).on("click", ".btn_io_status",function() {
        ...
        var url = "./contents/sj/storage_move/api/updateCell.php";
        ...
        var admin_memo = $tr.find("textarea[name='admin_memo']").val();
        ...
        var str = "mode=io_status&io_status="+io_status+qr_parameter+"&io_idx="+io_idx+"&out_date="+out_date+"&receive_date="+receive_date+"&admin_memo="+admin_memo; //
        ...
        $.ajax( { 
                ...
                success: function(result){
                    ...
                    if(result_status == 1)
                    {
                        ...
                        $td.find("button.btn_qr_out").remove();
        ...
        $.ajax( { 
                ...
                success: function(result){
                    ...
                    if(result_status == 1)
                    {
                        ...
                        if(io_status == "이동출고취소"){
                            $(this).removeClass("btn-primary").addClass("btn-dark").text("취소완료");
                        }
...
function go_next_status(qr_code){
    ...
    var str = "mode=io_status&qr_mode=qr&qr_code="+qr_code+"&io_status="+next_io_status+"&io_idx="+io_idx+"&out_date="+out_date+"&receive_date="+receive_date+"&admin_memo="+admin_memo; //
